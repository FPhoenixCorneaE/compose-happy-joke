...
/**
 * @desc：首页纯图片列表数据源
 * @date：2023/04/21 09:24
 */
class HomepageFunnyPicturesSource : PagingSource<Int, HomepageRecommend.Data>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, HomepageRecommend.Data> {
        return runCatching {
            ...
            LoadResult.Page(
                data = homepageService.homepageFunnyPictures()?.data ?: mutableListOf(),
